...
public class GameManager : MonoBehaviour
{
    ...
    private PikachuTile[,] board;
    private PikachuTile firstSelected, secondSelected;
    ...
    void GenerateBoard()
    {
        ...
        board = new PikachuTile[rows, cols];
        ...
        for (int r = 0; r < rows; r++)
        {
            for (int c = 0; c < cols; c++)
            {
                ...
                PikachuTile tile = obj.GetComponent<PikachuTile>();
                tile.SetSprite(spriteList[spriteIndex++]);
    ...
    public void SelectTile(PikachuTile tile)
    {
    ...
    bool CanConnect(PikachuTile tile1, PikachuTile tile2)
    {
