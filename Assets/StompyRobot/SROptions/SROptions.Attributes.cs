...
public partial class SROptions
{
    ...
    // These attributes are used when using SROptions. Options added via SRDebug._instance.AddOptionsContainer can use the attribute defined in SRDebugger namespace.
